...
RequirementType = Literal[
    "No languages in the vacancy",
    "Single language in the vacancy",
    ...
    prompt = [
        ...
        },
        {
            ...
            "content": (
                ...
                "   - 'No languages in the vacancy' if no languages are required.\n"
                "   - 'Single language in the vacancy' if only one language is required.\n"
                "   - 'All languages are required' if all listed languages are required.\n"
                "   - 'Any of languages' if any of the listed languages is acceptable.\n"
...
#                 "2. Identify the required level of language mentioned in the job description.  "
#                 f"Consider 'Fluent' as 'B2'. "
#                 f"If a range is provided, such as 'B2-C1', return the lower edge of range ('B2' in that case). \n"
