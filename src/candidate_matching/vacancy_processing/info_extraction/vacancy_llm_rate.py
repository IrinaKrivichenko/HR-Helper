    ...
    prompt = [
        ...
        },
        {
            ...
            "content": (
                ...
                #f"If phrases like 'up to' are used, extract the numerical value and assume it is per month unless otherwise specified. "
                "3.  Determine the payment period using these rules:\n"
                "   - If the description mentions 'per hour', 'hourly', '/hr', or '/hour', use 'per hour'.\n"
                ...
                "   - If the description mentions 'per month', 'monthly', 'gross', or 'salary' (without 'per hour/day/week'), use 'per month'.\n"
