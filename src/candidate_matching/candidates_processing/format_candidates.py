...
def convert_language_levels(language_string):
    language_codes = {
        ...
        "Ukrainian": "UA", "Belarusian": "BY", "Belarussian": "BY", "Russian": "RU", "Polish": "PL",
        "Latvian": "LV", "Lithuanian": "LT", "Estonian": "ET",
        "Dutch": "NL", "Swedish": "SV", "Norwegian": "NO", "Finnish": "FI", "Danish": "DA",
        "French": "FR", "Spanish": "ES", "Italian": "IT", "Portuguese": "PT", "Greek": "EL",
        "Czech": "CS", "Slovak": "SK", "Hungarian": "HU", "Romanian": "RO", "Bulgarian": "BG",
        "Croatian": "HR", "Serbian": "SR", "Slovenian": "SL", "Macedonian": "MK", "Albanian": "SQ", "Moldovan": "MO",
        "Turkish": "TR", "Arabic": "AR", "Persian": "FA",
        "Chinese": "ZH", "Japanese": "JA", "Korean": "KO", "Hindi": "HI",
        "Thai": "TH", "Vietnamese": "VI", "Indonesian": "ID",
        "Hebrew": "HE",
        "Armenian": "HY", "Azerbaijani": "AZ", "Georgian": "KA", "Kazakh": "KK", "Uzbek": "UZ", "Tajik": "TG", "Kyrgyz": "KY",
        "Mongolian": "MN", "Tatar": "TT", "Bashkir": "BA", "Chuvash": "CV",
    }
